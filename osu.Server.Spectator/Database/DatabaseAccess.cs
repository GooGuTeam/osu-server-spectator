    ...
    public class DatabaseAccess : IDatabaseAccess
    {
        ...
        private async Task<MySqlConnection> getConnectionAsync()
        {
            ...
            string connectionString = string.IsNullOrEmpty(AppSettings.DatabasePassword)
                ? $"Server={AppSettings.DatabaseHost};Port={AppSettings.DatabasePort};Database={AppSettings.DatabaseName};User ID={AppSettings.DatabaseUser};ConnectionTimeout=15;ConnectionReset=false;Pooling=true;Pipelining=false;MinPoolSize=100;MaximumPoolSize=100"
                : $"Server={AppSettings.DatabaseHost};Port={AppSettings.DatabasePort};Database={AppSettings.DatabaseName};User ID={AppSettings.DatabaseUser};Password={AppSettings.DatabasePassword};ConnectionTimeout=15;ConnectionReset=false;Pooling=true;Pipelining=false;MinPoolSize=100;MaximumPoolSize=100";
